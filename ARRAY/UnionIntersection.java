...
//Write a program that takes two array and find the union and intesection of those array
import java.util.*;

public class UnionIntersection {

    public static void printUnion(int arr1[], int arr2[], int len1, int len2) {
    ...
    public static void printIntersection(int arr1[], int arr2[], int len1, int len2) {
